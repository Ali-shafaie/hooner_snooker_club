...
import { Table, UserCheck } from "lucide-react";
...
export default function Sidebar() {
  ...
  return (
    <div>
      <div className="flex md:hidden text-3xl mt-6 mr-4">
        <button
      ...
      <aside
        ...
        className={`${
          isOpen ? "block" : "hidden"
        } md:hidden block right-0 top-16  sm:w-64 h-screen transition-all ease-in-out duration-300 `}
      >
        <div className="h-full px-2 sm:px-3 py-12 overflow-y-auto bg-green-600 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li onClick={toggleSidebar}>
              <Link
                href="/"
                className="flex items-center p-2 text-white hover:text-gray-900 rounded-[10px] dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
