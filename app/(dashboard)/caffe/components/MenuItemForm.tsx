            ...
            <div className="p-5">
              <Formik
                initialValues={{
                  ...
                  buyPrice: row?.original.buyPrice ?? 0,
                ...
                onSubmit={async (values, { resetForm }) => {
                  ...
                  if (row) {
                    await axios
                      .patch(`/api/menuItem/${row.original.id}`, values)
                      .then((res) => {
                        if (res.status === 200) {
                          resetForm();
                          toast.success("منیو موفقانه ویرایش گردید");
                          setIsOpen(false);
                          setIsLoading(false);
                      ...
                      <div className="flex flex-col space-y-4 gap-1 py-1">
                        ...
                        <div className="items-center gap-4">
                          ...
                          >
                            ...
                            <option value="FOOD">رستورانت</option>
                            <option value="DRINK">کانتین</option>
                          </Field>
                          <ErrorMessage
                            name="category"
                            component="div"
